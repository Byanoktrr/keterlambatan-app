...
@section('content')
        ...
        <div class="toolbar">
            <div
                ...
                <div class="page-title d-flex flex-column me-5">
                    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Data Siswa</h1>
    ...
    <div class="d-flex justify-content-between">
        <form action="{{ route('student.indexPs') }}" method="GET" class="d-flex">
            <div class="input-group">
                <input type="name" name="search" class="form-control">
                <button type="submit" class="btn btn-primary">Cari</button>
            </div>
            <a href="{{ route('student.indexPs') }}" class="btn btn'-primary">Resfresh</a>
        </form>
    </div>
    <table class="table table-row-dashed table-row-gray-300 gy-4">
        <thead>
