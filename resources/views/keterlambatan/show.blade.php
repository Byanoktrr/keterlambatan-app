        ...
        <div
            ...
            <div class="page-title d-flex flex-column me-5">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    ...
                    <li class="breadcrumb-item text-dark">Show</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="item p-4" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.2); border-radius:10px;">
...
?>
        ...
        @foreach ($lates as $late)
            <div class="col-md-4" >
                <div class="card border" >
                    <div class="card-body border border-gray-500 border-active active" style="border-radius: 10px">
                        ...
                        <div class="text-center">
                            <img class="align-center img-fluid" src="{{ asset('storage/images/' . $late->bukti) }}" width="300px">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <a href="{{ route('keterlambatan.index') }}" class="btn btn-primary my-3">Kembali</a>
</div>
